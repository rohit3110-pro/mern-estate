...
import SearchMapComponent from '../components/SearchMapComponent'; // Import the SearchMapComponent
...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Swiper navigation>
        {offerListings && offerListings.length > 0 && offerListings.map((listing) => (
          <SwiperSlide key={listing._id}>
            <div style={{ background: `url(${listing.imageUrls[0]}) center no-repeat`, backgroundSize: 'cover' }} className='h-[500px] border'>
            </div>
          </SwiperSlide>
        ))}
      </Swiper>
      ...
      {/* Listings Section */}
      <div className='flex flex-col gap-8 max-w-6xl mx-auto p-3 my-10'>
      ...
      <div className='mt-[-10px]'>
        <h1 className='text-center mx-auto font-semibold text-2xl '>Find the listing location on the map and get the exact location!</h1>
        <div className='border-black flex flex-1 flex-col h-[500px] mx-auto'>
          {/* Integrate the SearchMapComponent here */}
          <SearchMapComponent />
        </div>
      </div>
    </div>
